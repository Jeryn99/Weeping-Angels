...
public class RenderTileEntityCG extends BlockEntityRenderer<TileEntityChronodyneGenerator>
{

    private ModelCG model = new ModelCG();

    @Override public void render(TileEntityChronodyneGenerator tile, double x, double y, double z, float float_1, int int_1)
    {
