 ...
 */
public class ModelAngelEd extends BipedEntityModel<EntityWeepingAngel> {

    private Cuboid right_wing_0;
	private Cuboid left_wing_0;
	private Cuboid back_cloth_2;
	private Cuboid head_2;
	private Cuboid body_2;
	private Cuboid head;
	private Cuboid body;
	private Cuboid left_arm;
	private Cuboid right_arm;
	private Cuboid cloth_0;
	private Cuboid cloth_1;
	private Cuboid cloth_2;
	private Cuboid back_cloth;
	private Cuboid left_wing_1;
	private Cuboid right_wing_1;
	private Cuboid nose;
	private Cuboid face;
	private Cuboid right_eyebrow;
	private Cuboid left_eyebrow;
	private Cuboid coverup;
	private Cuboid angry_mouth;
	private Cuboid teeth;
	private Cuboid teeth_1;
	private Cuboid teeth_2;
	private Cuboid teeth_3;
	private Cuboid teeth_4;
	private Cuboid teeth_5;
	private Cuboid left_arm_1;
	private Cuboid right_arm_1;
	private Cuboid zeth;
	private Cuboid left_wing_2;
	private Cuboid left_wing_3;
	private Cuboid left_wing_4;
	private Cuboid right_wing_2;
	private Cuboid right_wing_3;
	private Cuboid right_wing_4;

    public ModelAngelEd() {
		textureWidth = 88;
		textureHeight = 88;
		teeth_1 = new Cuboid(this, 63, 39);
		...
		right_arm = new Cuboid(this, 0, 32);
		...
		right_wing_4 = new Cuboid(this, 24, 16);
		...
		body = new Cuboid(this, 56, 0);
		body.setRotationPoint(0.0F, 0.0F, 0.0F);
		body.addBox(-4.0F, 0.0F, -2.0F, 8, 24, 4, 0.0F);
		right_wing_0 = new Cuboid(this, 0, 49);
		...
		left_wing_0 = new Cuboid(this, 38, 50);
		...
		left_wing_3 = new Cuboid(this, 14, 36);
		...
		right_arm_1 = new Cuboid(this, 20, 52);
	...
	@Override public void render(EntityWeepingAngel entity_1, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
	{
		GlStateManager.pushMatrix();
		GL11.glEnable(GL11.GL_CULL_FACE);
		GlStateManager.enableLighting();
		angelAngles(limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch, scale, entity_1);
		cloth_1.render(scale);
		right_arm.render(scale);
		head.render(scale);
		cloth_0.render(scale);
	...
	@Override public void setAngles(EntityWeepingAngel entity_1, float float_1, float float_2, float float_3, float float_4, float float_5, float float_6)
	{

	}

	@Override protected Cuboid getArm(OptionMainHand optionMainHand_1)
	{
		return optionMainHand_1 == OptionMainHand.LEFT ? left_arm : right_arm;
	}
    ...
    private void angelAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netheadYaw, float headPitch, float scaleFactor, Entity entity) {
        ...
        if (entity instanceof EntityWeepingAngel) {
            ...
            if (pose != null) {
                this.angry_mouth.visible = !pose.angryFace();
				pose.setArmAngles(this.left_arm, this.right_arm, this.left_arm_1, this.right_arm_1);
				pose.setWingAngles(this.left_wing_0, this.right_wing_0);
				pose.setHeadAngles(this.head);

                if (pose.angryFace()) {
					this.right_eyebrow.roll = (float) (20 * Math.PI / 180);
					this.left_eyebrow.roll = (float) (-20 * Math.PI / 180);
					this.angry_mouth.visible = false;
				} else {
					this.right_eyebrow.roll = (float) (0 * Math.PI / 180);
					this.left_eyebrow.roll = (float) (0 * Math.PI / 180);
				}

                if (pose instanceof PoseThinking) {
					this.right_eyebrow.roll = 0.15F;
