...
public class ModelAngelChild extends BipedEntityModel<EntityWeepingAngel>
{
	Cuboid head_2;
	Cuboid head;
	Cuboid body;
	...
	Cuboid right_wing_3;
	Cuboid right_wing_4;
	Cuboid right_wing_1_1;
	Cuboid right_wing_2_1;
	Cuboid right_wing_3_1;
	Cuboid right_wing_4_1;

	public ModelAngelChild()
	{
		this.textureWidth = 64;
		this.textureHeight = 64;
		this.mouthtop = new Cuboid(this, 24, 0);
		this.mouthtop.setRotationPoint(0.0F, 0.0F, -4.0F);
		this.mouthtop.addBox(-3.5F, -2.6F, -0.01F, 7, 2, 1, 0.0F);
		this.left_arm = new Cuboid(this, 0, 48);
		...
		this.right_wing_3_1 = new Cuboid(this, 16, 32);
		...
		this.right_wing_4_1 = new Cuboid(this, 16, 32);
		...
		this.right_wing_0_1 = new Cuboid(this, 16, 23);
		...
		this.right_wing_0 = new Cuboid(this, 16, 34);
		...
		this.head_2 = new Cuboid(this, 32, 0);
		...
		this.right_wing_3 = new Cuboid(this, 16, 32);
		...
		this.right_wing_2_1 = new Cuboid(this, 16, 32);
	...
	@Override
	public void render(EntityWeepingAngel angel, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
	{

		if (angel.getSeenTime() == 1)
			angelAngles(limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch, scale, angel);
		...
		GlStateManager.translatef(this.body.rotationPointX * scale, this.body.rotationPointY * scale, this.body.rotationPointZ * scale);
	...
	public void angelAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netheadYaw, float headPitch, float scaleFactor, Entity entity)
	{
		...
		this.left_arm.pitch = MathHelper.cos(limbSwing * 0.6662F + (float) Math.PI) * 2.0F * limbSwingAmount * 0.5F / 1.0F;
		this.right_arm.pitch = MathHelper.cos(limbSwing * 0.6662F) * 2.0F * limbSwingAmount * 0.5F / 1.0F;

		this.head.yaw = netheadYaw * 0.017453292F;
		this.head.pitch = headPitch * 0.017453292F;
		this.head_2.yaw = netheadYaw * 0.017453292F;
		this.head_2.pitch = headPitch * 0.017453292F;

		this.left_leg.pitch = MathHelper.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount / 1.0F;
		this.right_leg.pitch = MathHelper.cos(limbSwing * 0.6662F + (float) Math.PI) * 1.4F * limbSwingAmount / 1.0F;
	}
}
