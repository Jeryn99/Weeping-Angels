...
public class ModelAngel extends EntityModel<EntityWeepingAngel>
{
	
	/**
	 * Weeping Angel - Ford Created using Techne
	 */
    private Cuboid AngryLeftArm2;
    private Cuboid AngryRightArm2;
    private Cuboid AngryLeftArm1;
    private Cuboid AngryRightArm1;
    private Cuboid LeftEyebrow;
    private Cuboid RightEyebrow;
    private Cuboid Headband;
    private Cuboid Nose;
    private Cuboid Chin;
    private Cuboid ChinAngleLeft;
    private Cuboid ChinAngleRight;
    private Cuboid CheekLeft;
    private Cuboid CheekRight;
    private Cuboid HeadMain;
    private Cuboid HeadUnder;
    private Cuboid Teeth;
    private Cuboid Hair1;
    private Cuboid Hair2;
    private Cuboid Hair3;
    private Cuboid Hair4;
    private Cuboid Hair5;
    private Cuboid Hair6;
    private Cuboid Hair7;
    private Cuboid Hair8;
    private Cuboid Hair9;
    private Cuboid Hair10;
    private Cuboid Hair11;
    private Cuboid Hair12;
    private Cuboid TorsoMain;
    private Cuboid Dress1;
    private Cuboid Dress2;
    private Cuboid Dress3;
    private Cuboid Dress4;
    private Cuboid Dress5;
    private Cuboid Dress6;
    private Cuboid Dress7;
    private Cuboid Dress8;
    private Cuboid Dress9;
    private Cuboid Dress10;
    private Cuboid Dress11;
    private Cuboid Dress12;
    private Cuboid Dress13;
    private Cuboid RightArm1;
    private Cuboid RightArm2;
    private Cuboid LeftArm1;
    private Cuboid LeftArm2;
    private Cuboid LeftWing1;
    private Cuboid LeftWing2;
    private Cuboid LeftWing3;
    private Cuboid LeftWing4;
    private Cuboid LeftWing5;
    private Cuboid LeftWing6;
    private Cuboid LeftWing7;
    private Cuboid LeftWing8;
    private Cuboid LeftWing9;
    private Cuboid RightWing1;
    private Cuboid RightWing2;
    private Cuboid RightWing3;
    private Cuboid RightWing4;
    private Cuboid RightWing5;
    private Cuboid RightWing6;
    private Cuboid RightWing7;
    private Cuboid RightWing8;
    private Cuboid RightWing9;
	
	public ModelAngel() {
		textureWidth = 128;
		textureHeight = 128;
		
		LeftEyebrow = new Cuboid(this, 50, 8);
		...
		RightEyebrow = new Cuboid(this, 50, 8);
		...
		ChinAngleRight = new Cuboid(this, 62, 5);
		...
		CheekLeft = new Cuboid(this, 62, 0);
		...
		CheekRight = new Cuboid(this, 62, 0);
		...
		HeadUnder = new Cuboid(this, 32, 0);
		...
		TorsoMain = new Cuboid(this, 16, 16);
		...
		RightArm1 = new Cuboid(this, 58, 16);
		...
		RightArm2 = new Cuboid(this, 58, 25);
		...
		LeftArm1 = new Cuboid(this, 40, 16);
		...
		LeftArm2 = new Cuboid(this, 40, 25);
		...
		LeftWing1 = new Cuboid(this, 0, 43);
		...
		LeftWing2 = new Cuboid(this, 10, 43);
		...
		LeftWing3 = new Cuboid(this, 20, 43);
		...
		LeftWing4 = new Cuboid(this, 26, 43);
		...
		LeftWing5 = new Cuboid(this, 32, 43);
		...
		LeftWing6 = new Cuboid(this, 38, 43);
		...
		LeftWing7 = new Cuboid(this, 44, 43);
		...
		LeftWing8 = new Cuboid(this, 50, 43);
		...
		LeftWing9 = new Cuboid(this, 56, 43);
		...
		RightWing1 = new Cuboid(this, 0, 43);
		...
		RightWing2 = new Cuboid(this, 10, 43);
		...
		RightWing3 = new Cuboid(this, 20, 43);
		...
		RightWing4 = new Cuboid(this, 26, 43);
		...
		RightWing5 = new Cuboid(this, 32, 43);
		...
		RightWing6 = new Cuboid(this, 38, 43);
		...
		RightWing7 = new Cuboid(this, 44, 43);
		...
		RightWing8 = new Cuboid(this, 50, 43);
		...
		RightWing9 = new Cuboid(this, 56, 43);
		...
		AngryRightArm1 = new Cuboid(this, 58, 16);
		...
		AngryRightArm2 = new Cuboid(this, 58, 25);
		...
		AngryLeftArm1 = new Cuboid(this, 40, 16);
		...
		AngryLeftArm2 = new Cuboid(this, 40, 25);
	...
	@Override public void render(EntityWeepingAngel entity_1, float float_1, float float_2, float float_3, float float_4, float float_5, float scale)
	{
		super.render(entity_1, float_1, float_2, float_3, float_4, float_5, scale);
		// Head
		GlStateManager.pushMatrix();

		GlStateManager.pushMatrix();
		GlStateManager.enableLighting();
		if (!entity_1.getPose().equals(PoseManager.AngelPoses.ANGRY.toString())) {
