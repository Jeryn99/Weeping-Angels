...
public class ModelArmsCovering extends EntityModel< Entity > {

    RendererModel RightFinger2;
    RendererModel RightArm2;
    RendererModel RightFinger1;
    RendererModel RightThumb;
    RendererModel RightHand;
    RendererModel RightArm1;
    RendererModel RightArmBottom;
    RendererModel RightArmMain;
    RendererModel LeftHand;
    RendererModel LeftFinger2;
    RendererModel LeftFinger1;
    RendererModel LeftThumb;
    RendererModel LeftArm1;
    RendererModel LeftArm2;
    RendererModel LeftArmMain;
    RendererModel LeftArmBottom;

    public ModelArmsCovering() {
        textureWidth = 128;
        textureHeight = 128;

        RightFinger2 = new RendererModel(this, 85, 29);
        ...
        RightArm2 = new RendererModel(this, 85, 25);
        ...
        RightFinger1 = new RendererModel(this, 85, 29);
        ...
        RightThumb = new RendererModel(this, 87, 38);
        ...
        RightHand = new RendererModel(this, 85, 25);
        ...
        RightArm1 = new RendererModel(this, 85, 25);
        ...
        RightArmBottom = new RendererModel(this, 78, 25);
        ...
        RightArmMain = new RendererModel(this, 62, 25);
        ...
        LeftFinger1 = new RendererModel(this, 85, 29);
        ...
        LeftThumb = new RendererModel(this, 87, 38);
        ...
        LeftArm1 = new RendererModel(this, 85, 25);
        ...
        LeftArm2 = new RendererModel(this, 85, 25);
        ...
        LeftArmMain = new RendererModel(this, 62, 25);
        ...
        LeftArmBottom = new RendererModel(this, 78, 25);
