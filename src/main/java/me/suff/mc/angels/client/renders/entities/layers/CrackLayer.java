package me.suff.mc.angels.client.renders.entities.layers;
...
public class CrackLayer extends LayerRenderer<WeepingAngelEntity, EntityModel<WeepingAngelEntity>> {
    ...
    private EntityModel<WeepingAngelEntity> modelOne = new ModelAngel<>();
    ...
    private EntityModel<WeepingAngelEntity> modelClassic = new ModelClassicAngel<>();
