...
import me.swirtzly.minecraft.angels.common.events.FortuneLevelEvent;
...
/**
 * Created by 50ap5ud5 on 13 Feb 2020 @ 11:59:07 am
 */
public class WAEnchantHelper {
	...
	public static int getFortuneLevel(Entity target, @Nullable Entity killer, DamageSource cause) {
		int fortune = 0;
		if (killer instanceof LivingEntity) fortune = getFortuneModifier((LivingEntity) killer);
		if (target instanceof LivingEntity) fortune = getFortuneLevel((LivingEntity) target, cause, fortune);
		return fortune;
	}
