...
public class WARecipeGen extends RecipeProvider {
    ...
    protected void registerRecipes(Consumer< IFinishedRecipe > consumer) {
        ...
        ShapelessRecipeBuilder.shapelessRecipe(WAObjects.Items.CHISEL.get()).addIngredient(ItemTags.STONE_BRICKS).addIngredient(Items.STRING).addIngredient(Items.STICK).addCriterion("has_stone", hasItem(ItemTags.STONE_BRICKS)).build(consumer);
