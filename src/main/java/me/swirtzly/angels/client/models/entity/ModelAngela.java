...
public class ModelAngela extends EntityModel<WeepingAngelEntity> {
    ...
    public ModelAngela() {
        ...
        bb_main.cubeList.add(new ModelBox(bb_main, 0, 1, -4.0F, -25.0F, -1.5F, 8, 12, 3, 0.0F, false));
        bb_main.cubeList.add(new ModelBox(bb_main, 0, 1, -4.0F, -20.0F, -1.875F, 8, 2, 3, 0.0F, false));

        rightarm = new RendererModel(this);
        rightarm.setRotationPoint(-5.5F, -1.0F, 0.2F);
        rightarm.cubeList.add(new ModelBox(rightarm, 0, 0, -1.5F, 0.0F, -1.5F, 3, 12, 3, 0.0F, false));

        leftarm = new RendererModel(this);
        leftarm.setRotationPoint(5.5F, -1.0F, 0.2F);
        leftarm.cubeList.add(new ModelBox(leftarm, 2, 0, -1.5F, 0.0F, -1.5F, 3, 12, 3, 0.0F, false));

        Head = new RendererModel(this);
        Head.setRotationPoint(0.0F, 24.0F, 0.0F);
        Head.cubeList.add(new ModelBox(Head, 0, 0, -4.0F, -33.0F, -3.0F, 8, 8, 7, 0.0F, false));
        Head.cubeList.add(new ModelBox(Head, 0, 0, -4.0F, -33.0F, -4.0F, 8, 3, 1, 0.0F, false));
        Head.cubeList.add(new ModelBox(Head, 0, 0, -4.0F, -26.0F, -4.0F, 8, 1, 1, 0.0F, false));
        Head.cubeList.add(new ModelBox(Head, 0, 0, -4.0F, -30.0F, -4.0F, 1, 4, 1, 0.0F, false));
        Head.cubeList.add(new ModelBox(Head, 0, 0, 3.0F, -30.0F, -4.0F, 1, 4, 1, 0.0F, false));
        ...
        Wings.setRotationPoint(0.0F, 23.0F, 0.0F);
        ...
        Left.setRotationPoint(-5.0F, 0.3F, 0.2F);
        ...
        Right2.setRotationPoint(4.0F, 0.3F, -1.5F);
        setRotationAngle(Right2, 0.0F, -1.0472F, 0.0F);
        Wings.addChild(Right2);

        bone14 = new RendererModel(this);
        bone14.setRotationPoint(0.0F, 0.0F, 0.0F);
        setRotationAngle(bone14, 0.0873F, 0.0F, 0.0F);
        Right2.addChild(bone14);
        bone14.cubeList.add(new ModelBox(bone14, 0, 0, 0.5F, -21.8171F, 8.2218F, 1, 1, 4, 0.0F, false));
        bone14.cubeList.add(new ModelBox(bone14, 0, 0, 0.5F, -27.2595F, 21.2465F, 1, 23, 1, 0.0F, false));
        bone14.cubeList.add(new ModelBox(bone14, 0, 0, 0.4949F, -27.2195F, 20.7036F, 1, 22, 1, 0.0F, false));
        bone14.cubeList.add(new ModelBox(bone14, 0, 0, 0.5F, -29.2595F, 20.2465F, 1, 4, 1, 0.0F, false));
        bone14.cubeList.add(new ModelBox(bone14, 0, 0, 0.5917F, -29.254F, 20.3087F, 0, 20, 1, 0.0F, false));
        bone14.cubeList.add(new ModelBox(bone14, 0, 0, 0.5917F, -29.254F, 19.3087F, 0, 3, 1, 0.0F, false));
        bone14.cubeList.add(new ModelBox(bone14, 0, 0, 0.7786F, -30.2383F, 18.4888F, 0, 15, 1, 0.0F, false));
        bone14.cubeList.add(new ModelBox(bone14, 0, 0, 0.7786F, -23.2345F, 14.576F, 0, 5, 1, 0.0F, false));
        bone14.cubeList.add(new ModelBox(bone14, 0, 0, 0.7786F, -22.2345F, 12.576F, 0, 6, 1, 0.0F, false));
        bone14.cubeList.add(new ModelBox(bone14, 0, 0, 0.7853F, -22.2247F, 9.6872F, 0, 7, 1, 0.0F, false));
        bone14.cubeList.add(new ModelBox(bone14, 0, 0, 0.7786F, -22.2345F, 13.576F, 0, 5, 1, 0.0F, false));
        bone14.cubeList.add(new ModelBox(bone14, 0, 0, 0.7786F, -30.2383F, 17.4888F, 0, 4, 1, 0.0F, false));
        bone14.cubeList.add(new ModelBox(bone14, 0, 0, 0.7853F, -29.2323F, 16.5129F, 0, 4, 1, 0.0F, false));
        bone14.cubeList.add(new ModelBox(bone14, 0, 0, 0.8795F, -30.2358F, 17.5171F, 0, 14, 1, 0.0F, false));
        bone14.cubeList.add(new ModelBox(bone14, 0, 0, 0.8795F, -30.2358F, 16.5171F, 0, 13, 1, 0.0F, false));
        bone14.cubeList.add(new ModelBox(bone14, 0, 0, 0.8795F, -29.2358F, 15.5171F, 0, 11, 1, 0.0F, false));
        bone14.cubeList.add(new ModelBox(bone14, 0, 0, 0.8844F, -22.2272F, 11.6589F, 0, 7, 1, 0.0F, false));
        bone14.cubeList.add(new ModelBox(bone14, 0, 0, 0.8752F, -21.9254F, 10.6668F, 0, 7, 1, 0.0F, false));
        bone14.cubeList.add(new ModelBox(bone14, 0, 0, 0.8661F, -21.9224F, 8.7008F, 0, 6, 1, 0.0F, false));
        bone14.cubeList.add(new ModelBox(bone14, 0, 0, 0.6835F, -30.2486F, 19.371F, 0, 17, 1, 0.0F, false));
        bone14.cubeList.add(new ModelBox(bone14, 0, 0, 0.6835F, -29.9459F, 18.432F, 0, 3, 1, 0.0F, false));
        ...
        Face.setRotationPoint(0.0F, 24.0F, 0.0F);
