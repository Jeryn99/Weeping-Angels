...
import craig.software.mc.angels.common.level.structures.CatacombStructureJigsaw;
import craig.software.mc.angels.common.level.structures.GraveyardStructure;
...
public class WAFeatures {
    ...
    public static final DeferredRegister<StructureType<?>> STRUCTURES = DeferredRegister.create(Registry.STRUCTURE_TYPE_REGISTRY, WeepingAngels.MODID);
    ...
    public static final DeferredRegister<ConfiguredFeature<?, ?>> CONFIGURED_FEATURES = DeferredRegister.create(Registry.CONFIGURED_FEATURE_REGISTRY, WeepingAngels.MODID);
