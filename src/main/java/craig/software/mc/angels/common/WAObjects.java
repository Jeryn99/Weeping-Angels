...
import craig.software.mc.angels.common.entities.ChronodyneGeneratorEntity;
...
import craig.software.mc.angels.common.world.SnowAngelGeneration;
import craig.software.mc.angels.common.world.structures.CatacombStructure;
import craig.software.mc.angels.common.world.structures.GraveyardStructure;
import craig.software.mc.angels.common.world.structures.GraveyardStructurePieces;
...
public class WAObjects {
    ...
    public static class Items {
        ...
        public static final RegistryObject<Item> SALLY = ITEMS.register("music_disc_sally", () -> setUpItem(new MusicDiscItem(6, Sounds.DISC_SALLY::get, (new Item.Properties()).stacksTo(1).tab(ItemGroup.TAB_MISC).tab(WATabs.MAIN_TAB).rarity(Rarity.RARE))));
        public static final RegistryObject<Item> TIME_PREVAILS = ITEMS.register("music_disc_time_prevails", () -> setUpItem(new MusicDiscItem(6, Sounds.DISC_TIME_PREVAILS::get, (new Item.Properties()).stacksTo(1).tab(ItemGroup.TAB_MISC).tab(WATabs.MAIN_TAB).rarity(Rarity.RARE))));
    }
    ...
    public static class EntityEntries {
        ...
        public static final RegistryObject<EntityType<WeepingAngelEntity>> WEEPING_ANGEL = ENTITIES.register("weeping_angel", () -> registerFireResistMob(WeepingAngelEntity::new, WeepingAngelEntity::new, EntityClassification.MONSTER, 0.6F, 1.95F, "weeping_angel", false));
