...
import mc.craig.software.angels.utils.ForgePatchThis;
...
public class WARecipeGen extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(@NotNull Consumer<FinishedRecipe> consumer) {
        ShapedRecipeBuilder.shaped(WAObjects.Blocks.PLINTH.get().asItem()).pattern("#").pattern("S").pattern("Q").define('#', Blocks.STONE.asItem()).define('S', Blocks.SMOOTH_STONE.asItem()).define('Q', Blocks.QUARTZ_PILLAR).unlockedBy("has_crafting_table", ForgePatchThis.has(Tags.Items.STONE)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(WAObjects.Blocks.STATUE.get()).pattern("#").pattern("S").define('#', Blocks.STONE.asItem()).define('S', Blocks.SMOOTH_STONE.asItem()).unlockedBy("has_stone", ForgePatchThis.has(Tags.Items.STONE)).save(consumer);
        ShapedRecipeBuilder.shaped(WAObjects.Blocks.COFFIN.get()).pattern("WWW").pattern("WBW").pattern("WWW").define('W', ItemTags.LOGS).define('B', Items.BONE.asItem()).unlockedBy("has_bone", ForgePatchThis.has(Tags.Items.BONES)).save(consumer);
        ...
        ShapelessRecipeBuilder.shapeless(WAObjects.Items.CHISEL.get()).requires(ItemTags.STONE_CRAFTING_MATERIALS).requires(Items.STRING).requires(Items.STICK).unlockedBy("has_stone", ForgePatchThis.has(ItemTags.STONE_CRAFTING_MATERIALS)).save(consumer);
