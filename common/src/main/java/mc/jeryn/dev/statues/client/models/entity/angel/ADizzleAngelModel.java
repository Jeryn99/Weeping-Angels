...
import mc.jeryn.dev.statues.client.screen.ChiselScreen;
...
import static mc.jeryn.dev.statues.client.models.entity.angel.AliceAngelModel.ANIMATION_STREAM;
...
public class ADizzleAngelModel extends AngelModel {
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int k) {
        Angel.render(poseStack, vertexConsumer, packedLight, packedOverlay);
    }
