...
import mc.jeryn.dev.statues.client.models.MercyWingsModel;
import mc.jeryn.dev.statues.client.models.ModelRegistration;
import mc.jeryn.dev.statues.client.models.entity.angel.AliceAngelModel;
...
import mc.jeryn.dev.statues.donators.Donator;
...
import static mc.jeryn.dev.statues.client.render.blockentity.CoffinRenderer.rgbaToInt;
...
public class DonationWingsLayer<T extends LivingEntity, M extends HumanoidModel<T>, A extends HumanoidModel<T>> extends RenderLayer<T, M> {
    ...
    @Override
    public void render(PoseStack poseStack, MultiBufferSource multiBufferSource, int i, T entityRenderState, float f, float g) {
