...
public class WARecipeProvider extends net.minecraft.data.recipes.RecipeProvider {


    public WARecipeProvider(PackOutput arg, CompletableFuture<HolderLookup.Provider> completableFuture) {
