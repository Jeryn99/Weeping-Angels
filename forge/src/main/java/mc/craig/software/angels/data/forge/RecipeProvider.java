...
public class RecipeProvider extends net.minecraft.data.recipes.RecipeProvider {
    ...
    protected void buildCraftingRecipes(@NotNull Consumer<FinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(WABlocks.CHRONODYNE_GENERATOR.get(), 2).pattern("IPI").pattern("EKE").pattern("IRI").define('I', Items.IRON_INGOT).define('E', Items.CLOCK.asItem()).define('R', Items.REDSTONE).define('P', Blocks.STONE_BUTTON).define('K', WAItems.KONTRON_INGOT.get()).unlockedBy("has_kontron", has(WABlocks.KONTRON_ORE.get())).save(consumer);
